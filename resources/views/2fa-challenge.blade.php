...
<head>
    ...
    <title>2FA Verification — VaultScribe</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-input::placeholder { color: var(--gray-300); letter-spacing: 4px; font-weight: 500;}
...
<div class="auth-container">
    ...
    <div class="card">
        ...
        <p class="auth-text">
            Protecting your vault. Please enter the 6-digit code from your authenticator app.
        </p>
...
<script>
    ...
    document.querySelector('input[name="one_time_password"]').addEventListener('input', function (e) {
        ...
        if (this.value.length === 6) {
            // Give a slight delay for better UX before submitting
            setTimeout(() => {
