...
<head>
    ...
    <title>Create Account — VaultScribe</title>
...
<div class="auth-container">
    ...
    <div class="card">
        ...
        <p class="auth-text">Start securing your notes with military-grade protection.</p>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group">
                ...
                <input name="name" type="text" class="form-input" placeholder="e.g. John Doe" value="{{ old('name') }}" required autofocus>
            </div>
            ...
            <div class="form-group">
                ...
                <input name="password" type="password" class="form-input" placeholder="Create a strong password" required>
            </div>

            <div class="form-group" style="margin-bottom: 8px;">
                <label class="form-label">Confirm Password</label>
                <input name="password_confirmation" type="password" class="form-input" placeholder="Repeat your password" required>
            </div>
